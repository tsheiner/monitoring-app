...
describe('Crosshair Rendering', () => {
  ...
  it('should render vertical crosshair line on hover inside plot', () => {
    ...
    const chartCenterX = config.margin.left + (config.width - config.margin.left - config.margin.right) / 2;
    const chartCenterY = config.margin.top + (config.height - config.margin.top - config.margin.bottom) / 2;
  ...
  it('should update crosshair position as mouse moves', () => {
    ...
    const verticalLine1 = container.querySelector('.crosshair-vertical') as SVGLineElement;
    ...
    const verticalLine2 = container.querySelector('.crosshair-vertical') as SVGLineElement;
  ...
  it('should style crosshair with dashed lines', () => {
    ...
    const verticalLine = container.querySelector('.crosshair-vertical') as SVGLineElement;
    expect(verticalLine).toBeTruthy();
...
describe('Nearest Metric Detection', () => {
  ...
  it('should update nearest metric as cursor moves vertically', () => {
    ...
    chart.loadHistoricalData('metric1', [
      { timestamp: now - 1800, value: 30 },
    ]);

    chart.loadHistoricalData('metric2', [
      { timestamp: now - 1800, value: 70 },
    ]);
    ...
    const bottomY = config.margin.top + (config.height - config.margin.top - config.margin.bottom) - 50;
